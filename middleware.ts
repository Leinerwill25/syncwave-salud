...
const PUBLIC_ROUTES = ['/login', '/register', '/reset-password', '/safecare/login', '/api/auth', '/api/plans', '/api/register', '/api/organizations', '/api/public', '/api/role-users', '/api/analytics/login', '/'];
