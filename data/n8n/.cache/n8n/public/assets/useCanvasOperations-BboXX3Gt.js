...
import { M as useLocalStorage, S as useClipboard, _t as useI18n } from "./_MapCache-ficiegRb.js";
import { T as createEventBus, v as useRoute, y as useRouter } from "./truncate-B1HVeveJ.js";
import { B as PUSH_NODES_OFFSET, Gi as isPresent, Gn as useNodeHelpers, H as doRectsOverlap, I as CONFIGURATION_NODE_SIZE, J as getNewNodePosition, Kn as injectWorkflowState, L as DEFAULT_NODE_SIZE, M as useNDVStore, N as useWorkflowsStore, Nt as useNodeTypesStore, O as useTelemetry, P as CONFIGURABLE_NODE_SIZE, Qr as AddNodeCommand, R as DEFAULT_VIEWPORT_BOUNDARIES, Rn as useWorkflowHelpers, U as generateOffsets, Ur as isValidNodeConnectionType, Vn as useTagsStore, X as getNodesGroupSize, Xi as tryToParseNumber, Xn as useProjectsStore, Xr as useHistoryStore, Yr as CanvasNodeRenderType, Zr as AddConnectionCommand, ai as RenameNodeCommand, b as useExternalHooks, c as useTemplatesStore, fs as v4_default, gn as useCredentialsStore, gr as useCanvasStore, gs as useSettingsStore, ii as RemoveNodeCommand, j as usePostHog, kt as getExecutionErrorToastConfiguration, ni as MoveNodeCommand, oa as useUIStore, oi as ReplaceNodeParametersCommand, qn as useWorkflowState, qr as CanvasConnectionMode, r as useFocusPanelStore, ri as RemoveConnectionCommand, v as useToast, xn as useDataSchema, xt as isChatNode, z as GRID_SIZE } from "./builder.store-CgMqPgnW.js";
import { $i as getNodeInputs, Bo as VIEWS, Da as isCommunityPackageName, Dn as MCP_TRIGGER_NODE_TYPE, Ea as deepCopy, Fs as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ga as NodeConnectionTypes, Is as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Ls as LOCAL_STORAGE_LOGS_PANEL_OPEN, Oi as require__baseUniq, Qi as getConnectionTypes, Rs as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Sc as EnterpriseEditionFeature, Yi as generateNodesGraph, ea as getNodeOutputs, hr as WEBHOOK_NODE_TYPE, lc as CANVAS_ZOOMED_VIEW_EXPERIMENT, oa as getSubworkflowId, pc as NDV_IN_FOCUS_PANEL_EXPERIMENT, pr as UPDATE_WEBHOOK_ID_NODE_TYPES, sr as STICKY_NODE_TYPE, ta as getNodeParameters, un as FORM_TRIGGER_NODE_TYPE, yi as require_cloneDeep } from "./constants-B5yiZflE.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-CXJtK_5o.js";
