import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, Gt as unref, M as createVNode, P as defineComponent, T as createBlock, bt as withCtx, et as openBlock, j as createTextVNode, vn as normalizeClass, w as createBaseVNode } from "./vue.runtime.esm-bundler-tP5dCd7J.js";
import { _t as useI18n } from "./_MapCache-ficiegRb.js";
import { mt as N8nLink_default, xn as N8nText_default } from "./src-BiuB4CZc.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style["location-container"]) }, [
				_ctx.homeProject ? (openBlock(), createElementBlock("span", {
					key: 0,
					class: normalizeClass(_ctx.$style.truncate)
				}, [_ctx.asLinks ? (openBlock(), createBlock(unref(N8nLink_default), {
					key: 0,
				...
				_ctx.parentFolder || _ctx.workflowName ? (openBlock(), createElementBlock("span", {
					key: 1,
				...
				_ctx.parentFolder ? (openBlock(), createElementBlock("span", {
					key: 3,
					class: normalizeClass(_ctx.$style["parent-folder"])
				}, [_ctx.asLinks && _ctx.homeProject ? (openBlock(), createBlock(unref(N8nLink_default), {
					key: 0,
					...
					default: withCtx(() => [createVNode(unref(N8nText_default), {
						...
						default: withCtx(() => [createTextVNode(toDisplayString(_ctx.parentFolder.name), 1)]),
						_: 1
					}, 8, ["class"])]),
					_: 1
				}, 8, ["to", "class"])) : (openBlock(), createBlock(unref(N8nText_default), {
				...
				_ctx.workflowName ? (openBlock(), createElementBlock("span", {
					key: 5,
					class: normalizeClass([_ctx.$style["workflow-name"], _ctx.$style.truncate])
				}, [_ctx.asLinks && _ctx.workflowId ? (openBlock(), createBlock(unref(N8nLink_default), {
					key: 0,
					...
					default: withCtx(() => [createVNode(unref(N8nText_default), {
						...
						default: withCtx(() => [createTextVNode(toDisplayString(_ctx.workflowName), 1)]),
						_: 1
					}, 8, ["class"])]),
					_: 1
				}, 8, ["to", "class"])) : (openBlock(), createBlock(unref(N8nText_default), {
