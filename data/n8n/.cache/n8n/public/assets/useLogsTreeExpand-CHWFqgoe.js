...
import { B as useTimestamp, V as useVirtualList, _t as useI18n, at as useThrottleFn, m as require_isArray, vt as I18nT } from "./_MapCache-ficiegRb.js";
import { Sn as N8nButton_default, ht as N8nTooltip_default, wn as N8nIcon_default, xn as N8nText_default, xt as N8nIconButton_default } from "./src-BiuB4CZc.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { r as require_get, y as useRouter } from "./truncate-B1HVeveJ.js";
import { Fi as parse, Gn as useNodeHelpers, Kn as injectWorkflowState, N as useWorkflowsStore, Nt as useNodeTypesStore, bt as formatTokenUsageCount, fn as require_upperFirst, fs as v4_default, v as useToast, vt as addTokenUsageData, xt as isChatNode, yt as emptyTokenUsageData } from "./builder.store-CgMqPgnW.js";
import { Ec as LOGS_EXECUTION_DATA_THROTTLE_DURATION, Ga as NodeConnectionTypes, Hi as createEmptyRunExecutionData, Ja as AGENT_LANGCHAIN_NODE_TYPE, Ui as createRunExecutionData, bo as require__baseKeys, hi as parseErrorMetadata, mi as Workflow, vo as require__getTag, wn as MANUAL_CHAT_TRIGGER_NODE_TYPE, zt as CHAT_TRIGGER_NODE_TYPE } from "./constants-B5yiZflE.js";
import { C as require_isTypedArray, O as require_isBuffer, k as require_isArguments, x as require__isPrototype, y as require_isArrayLike } from "./merge-DjI8TA-7.js";
import { x as TOOL_EXECUTOR_NODE_NAME } from "./_baseOrderBy-DwurmLcj.js";
		...
		watch(() => props.isSelected, (isSelected) => {
			nextTick(() => {
				if (isSelected) {
					...
					if (!(activeElement?.getAttribute("data-test-id") === "chat-input" || activeElement?.closest("[data-test-id=\"canvas-chat\"]") !== null)) container$2.value?.focus();
				}
			});
		}, { immediate: true });
		return (_ctx, _cache) => {
