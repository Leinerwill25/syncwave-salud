...
import { Dr as useUsersStore, Ec as STORES, N as useWorkflowsStore, O as useTelemetry, gn as useCredentialsStore, gs as useSettingsStore, j as usePostHog, p as useCloudPlanStore, v as useToast } from "./builder.store-CgMqPgnW.js";
import { Bo as VIEWS, Ea as deepCopy, gc as READY_TO_RUN_V2_P3_EXPERIMENT, uo as OPEN_AI_API_CREDENTIAL_TYPE } from "./constants-B5yiZflE.js";
import { k as defineStore } from "./_baseOrderBy-DwurmLcj.js";
...
const useReadyToRunStore = defineStore(STORES.READY_TO_RUN, () => {
	...
	const isReadyToRunTemplateId = (templateId) => {
