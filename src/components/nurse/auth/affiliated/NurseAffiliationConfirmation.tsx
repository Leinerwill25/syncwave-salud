  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col items-center text-center gap-4 py-4">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-900 ">{organizationName}</h3>
      ...
      <div className="flex gap-3">
        <button
          onClick={onBack}
          className="flex items-center gap-2 border border-gray-300  text-gray-700  rounded-lg px-5 py-2.5 hover:bg-gray-50  transition-colors text-sm font-medium"
        >
