    ...
    <div className={cn('space-y-3', className)}>
      ...
      {!file ? (
        <button
          ...
          className="w-full flex flex-col items-center justify-center gap-3 border-2 border-dashed border-gray-300  rounded-xl p-8 hover:border-teal-400 hover:bg-teal-50  transition-all group"
        >
        ...
        <div className="border border-gray-200  rounded-xl overflow-hidden">
          {preview ? (
            ...
            <img src={preview} alt="Vista previa licencia" className="w-full h-40 object-contain bg-gray-50 " />
          ) : (
          ...
          <div className="flex items-center gap-2 p-3 bg-white  border-t border-gray-200 ">
            {uploadedUrl ? (
              <div className="flex items-center gap-2 flex-1">
                ...
                <span className="text-xs text-emerald-600  font-medium">Subida correctamente</span>
              </div>
            ) : (
              <button
                type="button"
                ...
                disabled={uploading}
                className="flex items-center gap-2 text-xs font-medium text-teal-600  hover:text-teal-700 disabled:opacity-60"
              >
