...
export function KpiCard({ title, value, description, decimals = 2, compact = false, className = '' }: KpiCardProps) {
	...
	return (
		<Card className={`w-full ${className}`} role="region" aria-label={`${title} KPI`}>
			...
			<CardContent className="px-3 pb-3 pt-0">
				<div className="flex flex-col items-center justify-center text-center w-full" style={{ minHeight: 64 }} /* compact base height */>
