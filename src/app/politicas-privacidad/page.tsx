		...
		<div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 w-full max-w-full overflow-x-hidden">
			<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
				...
				<div className="text-center mb-8 sm:mb-12">
					...
					<h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-slate-900 via-teal-700 to-cyan-600 bg-clip-text text-transparent mb-4">
				...
				<div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-12 space-y-8 sm:space-y-12">
					...
					<section className="space-y-4">
						...
						<div className="prose prose-slate max-w-none space-y-4 text-gray-700 leading-relaxed">
							...
							<p>
								Al utilizar nuestros servicios, usted acepta las prácticas descritas en esta política. Si no está de acuerdo con alguna parte 
							...
							<div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mt-6">
								<p className="text-sm text-blue-800">
									<strong>Nota importante:</strong> Esta plataforma maneja información de salud sensible. Todos los datos están protegidos 
									según las normativas aplicables en Venezuela y las mejores prácticas internacionales de seguridad de datos médicos.
								</p>
							</div>
						</div>
					</section>
						...
						<div className="space-y-6">
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
									<li><strong>Nombre completo</strong> (primer nombre y apellidos)</li>
									<li><strong>Cédula de identidad</strong> o documento de identificación</li>
									<li><strong>Fecha de nacimiento</strong></li>
									<li><strong>Género</strong></li>
									<li><strong>Dirección de residencia</strong></li>
									<li><strong>Números de teléfono</strong> (móvil y fijo)</li>
							...
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
									<li><strong>Historial médico completo</strong>, incluyendo consultas, diagnósticos y tratamientos</li>
									<li><strong>Signos vitales</strong> (presión arterial, frecuencia cardíaca, temperatura, peso, altura, etc.)</li>
									<li><strong>Alergias conocidas</strong> y reacciones adversas</li>
									<li><strong>Condiciones médicas crónicas</strong></li>
									<li><strong>Medicamentos actuales</strong> y prescritos</li>
									<li><strong>Historial familiar de enfermedades</strong></li>
									<li><strong>Resultados de laboratorio</strong> y estudios diagnósticos</li>
									<li><strong>Recetas médicas</strong> y órdenes de tratamiento</li>
									<li><strong>Notas médicas</strong> y observaciones clínicas</li>
									<li><strong>Imágenes médicas</strong> y documentos adjuntos</li>
									<li><strong>Motivo de consulta</strong> y síntomas reportados</li>
								</ul>
							</div>
							...
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
									<li><strong>Credenciales profesionales</strong> (licencia médica, número de colegiatura)</li>
									<li><strong>Especialidad médica</strong></li>
									<li><strong>Historial académico</strong> (universidad, título, año de graduación)</li>
									<li><strong>Certificaciones y cursos</strong></li>
									<li><strong>Firma digital</strong> y fotografía profesional</li>
									<li><strong>Horarios de disponibilidad</strong></li>
							...
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
									<li><strong>Datos legales</strong> (RIF, razón social, nombre comercial)</li>
									<li><strong>Dirección fiscal y operativa</strong></li>
									<li><strong>Información de contacto</strong> (teléfonos, correos, redes sociales)</li>
									<li><strong>Licencia sanitaria</strong> y número de seguro de responsabilidad</li>
									<li><strong>Datos bancarios</strong> (para procesamiento de pagos)</li>
									<li><strong>Fotografías del consultorio</strong> y perfil de la organización</li>
									<li><strong>Especialidades ofrecidas</strong> y servicios disponibles</li>
									<li><strong>Horarios de atención</strong> y disponibilidad</li>
								</ul>
							</div>
							...
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
									<li><strong>Información de facturación</strong> y métodos de pago</li>
									<li><strong>Historial de transacciones</strong> y pagos realizados</li>
									<li><strong>Comprobantes de pago</strong> y referencias de transferencia</li>
									<li><strong>Capturas de pantalla</strong> de comprobantes de pago (cuando el paciente las sube)</li>
									<li><strong>Estado de pagos pendientes</strong> y confirmados</li>
									<li><strong>Información de suscripciones</strong> y planes contratados</li>
								</ul>
								<div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
									<p className="text-sm text-yellow-800">
										<strong>Importante:</strong> No almacenamos números de tarjetas de crédito completos. 
										Toda la información de pago sensible es procesada por proveedores de pago seguros y certificados.
									</p>
								</div>
							</div>
							...
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
									<li><strong>Fechas y horarios de citas</strong> programadas</li>
									<li><strong>Estado de las citas</strong> (confirmada, cancelada, completada, reprogramada)</li>
									<li><strong>Motivo de la cita</strong> y notas adicionales</li>
									<li><strong>Ubicación de la consulta</strong> (presencial o virtual)</li>
									<li><strong>Historial de consultas</strong> y seguimientos</li>
								</ul>
							</div>
							...
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
									<li><strong>Dirección IP</strong> y ubicación geográfica aproximada</li>
									<li><strong>Tipo de dispositivo</strong> y sistema operativo</li>
									<li><strong>Navegador web</strong> y versión</li>
									<li><strong>Registros de actividad</strong> y logs de acceso</li>
									<li><strong>Cookies y tecnologías de seguimiento</strong> (ver sección 8)</li>
									<li><strong>Preferencias de notificación</strong> (email, WhatsApp, push)</li>
								</ul>
							</div>
							...
							<div className="bg-gray-50 rounded-xl p-6">
								...
								<p className="text-gray-700 mb-3">
									Cuando un profesional de la salud crea una consulta para un paciente que no está registrado en la plataforma, 
									recopilamos información básica para poder brindar el servicio médico:
								</p>
								<ul className="space-y-2 text-gray-700 ml-6 list-disc">
								...
								<div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
									<p className="text-sm text-blue-800">
										<strong>Nota:</strong> Esta información se almacena de forma segura y puede ser utilizada para futuras consultas 
										o para invitar al paciente a registrarse en la plataforma.
									</p>
								</div>
							</div>
						</div>
							...
							<div className="space-y-4">
								<div className="flex items-start gap-3 p-4 bg-indigo-50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-gray-700">
											Para gestionar citas, consultas, recetas, órdenes médicas, resultados de laboratorio y toda la documentación 
											médica necesaria para brindar atención de salud de calidad.
										</p>
									</div>
								</div>
								<div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-gray-700">
											Para enviar notificaciones sobre citas, recordatorios, resultados de exámenes, mensajes entre pacientes y profesionales, 
											y actualizaciones importantes del servicio.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-3 p-4 bg-purple-50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-gray-700">
											Para analizar el uso de la plataforma, identificar problemas técnicos, mejorar la experiencia del usuario y desarrollar 
								...
								<div className="flex items-start gap-3 p-4 bg-orange-50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-gray-700">
											Para cumplir con obligaciones legales, responder a solicitudes gubernamentales, proteger nuestros derechos legales y 
								...
								<div className="flex items-start gap-3 p-4 bg-teal-50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-gray-700">
											Para proteger la seguridad de la plataforma, detectar y prevenir fraudes, abusos y actividades no autorizadas, 
											y proteger los datos de nuestros usuarios.
										</p>
									</div>
								</div>
								<div className="flex items-start gap-3 p-4 bg-pink-50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-gray-700">
											Para permitir que los pacientes gestionen grupos familiares y compartan acceso a información médica con miembros 
											autorizados de su familia.
										</p>
									</div>
								</div>
							</div>
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							<p>
								<strong>No vendemos, alquilamos ni comercializamos su información personal o de salud.</strong> Sin embargo, podemos compartir 
							...
							<div className="space-y-4">
								<div className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50 rounded-r-lg">
									...
									<p className="text-sm">
										Compartimos su información médica con los profesionales de la salud que usted autoriza explícitamente, 
										incluyendo médicos, especialistas, laboratorios y farmacias que forman parte de su red de atención.
									</p>
								</div>
								<div className="border-l-4 border-green-500 pl-4 py-2 bg-green-50 rounded-r-lg">
									...
									<p className="text-sm mt-2">
										Estos proveedores están contractualmente obligados a proteger su información y solo pueden usarla para los fines 
										específicos para los que fueron contratados.
									</p>
								</div>
								<div className="border-l-4 border-orange-500 pl-4 py-2 bg-orange-50 rounded-r-lg">
									...
									<p className="text-sm">
										Podemos divulgar información si es requerido por ley, orden judicial, proceso legal, o si creemos de buena fe que 
										la divulgación es necesaria para:
									</p>
									<ul className="text-sm ml-6 mt-2 list-disc">
								...
								<div className="border-l-4 border-purple-500 pl-4 py-2 bg-purple-50 rounded-r-lg">
									...
									<p className="text-sm">
										Compartimos información cuando usted nos da su consentimiento explícito para hacerlo, como cuando autoriza a un 
										profesional de la salud a acceder a su historial médico o cuando se une a un grupo familiar.
									</p>
								</div>
								<div className="border-l-4 border-red-500 pl-4 py-2 bg-red-50 rounded-r-lg">
									...
									<p className="text-sm">
										En caso de emergencia médica donde la vida del paciente esté en peligro, podemos compartir información médica relevante 
										con profesionales de la salud de emergencia, siempre que sea necesario para salvar vidas.
									</p>
								</div>
							</div>
						</div>
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							<p>
								Implementamos medidas de seguridad técnicas, administrativas y físicas para proteger su información contra acceso no autorizado, 
							...
							<div className="mt-6 p-4 bg-yellow-50 border-l-4 border-yellow-500 rounded-r-lg">
								<p className="text-sm text-yellow-800">
									...
									Le recomendamos que mantenga su contraseña segura, no la comparta con nadie y cierre sesión cuando use dispositivos compartidos.
								</p>
							</div>
						</div>
					</section>
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							...
							<div className="mt-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-lg">
								<p className="text-sm text-blue-800">
									...
									<a href="mailto:syncwaveagency@gmail.com" className="underline font-semibold">syncwaveagency@gmail.com</a> o contáctenos 
									por WhatsApp al <strong>04242070878</strong>. Responderemos a su solicitud dentro de 30 días hábiles.
								</p>
							</div>
						</div>
					</section>
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							<p>
								Conservamos su información personal y de salud durante el tiempo necesario para cumplir con los propósitos descritos en esta política, 
								a menos que la ley requiera o permita un período de retención más largo:
							</p>
							<ul className="space-y-2 ml-6 list-disc">
								<li><strong>Registros médicos:</strong> Se conservan según los requisitos legales aplicables en Venezuela, generalmente por un mínimo de 10 años después de la última consulta.</li>
								<li><strong>Información de cuenta:</strong> Se conserva mientras su cuenta esté activa y durante un período adicional razonable después de su cierre.</li>
								<li><strong>Información financiera:</strong> Se conserva según los requisitos legales y fiscales aplicables, generalmente por 7 años.</li>
								<li><strong>Logs y registros de actividad:</strong> Se conservan por un período de 2 años para fines de seguridad y auditoría.</li>
							</ul>
							<div className="mt-4 p-4 bg-gray-50 rounded-lg">
								<p className="text-sm">
									<strong>Nota:</strong> Algunos datos pueden conservarse por períodos más largos si es necesario para cumplir con obligaciones legales, 
									resolver disputas, hacer cumplir nuestros acuerdos o por razones de seguridad.
								</p>
							</div>
						</div>
					</section>
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							...
							<p className="text-sm mt-4">
								Puede controlar y gestionar las cookies a través de la configuración de su navegador. Sin embargo, tenga en cuenta que deshabilitar 
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							<p>
								Nuestra plataforma no está dirigida directamente a menores de 18 años. No recopilamos intencionalmente información personal de menores 
								sin el consentimiento explícito y verificado de sus padres o tutores legales.
							</p>
							...
							<div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
								...
								<p className="text-sm mb-3">
									<strong>Estado actual:</strong> La funcionalidad de grupos familiares no está disponible en este momento. Sin embargo, estamos 
									desarrollando esta característica para permitir que padres, madres o tutores legales registren y gestionen la información médica 
									de menores de edad bajo su representación legal.
								</p>
								<p className="text-sm mb-3">
									<strong>Funcionalidad futura:</strong> Cuando esta funcionalidad esté disponible, los representantes legales (padres, madres o tutores) 
									podrán:
								</p>
							...
							<div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-lg">
								...
								<p className="text-sm">
									Al aceptar esta Política de Privacidad, usted consiente que cuando la funcionalidad de grupos familiares esté disponible, 
									estas disposiciones sobre protección de menores se aplicarán automáticamente. Los usuarios registrados antes de la implementación 
									de esta funcionalidad estarán sujetos a estas mismas políticas y términos cuando decidan utilizar la característica de grupos familiares.
								</p>
								<p className="text-sm mt-2">
									<strong>Notificación:</strong> Le notificaremos con anticipación cuando esta funcionalidad esté disponible y le proporcionaremos 
									información adicional sobre cómo utilizarla de manera segura y legal.
								</p>
							</div>
							...
							<div className="bg-gray-50 rounded-xl p-4">
								...
								<ul className="text-sm ml-6 list-disc space-y-1">
									<li><strong>Derecho de acceso:</strong> Acceder a toda la información personal y médica del menor</li>
									<li><strong>Derecho de rectificación:</strong> Corregir información inexacta o incompleta</li>
									<li><strong>Derecho de eliminación:</strong> Solicitar la eliminación de la información del menor, sujeto a requisitos legales y médicos</li>
									<li><strong>Derecho de oposición:</strong> Oponerse al procesamiento de información del menor para ciertos fines</li>
									<li><strong>Derecho de portabilidad:</strong> Solicitar la transferencia de información del menor a otro proveedor</li>
									<li><strong>Derecho de revocación:</strong> Revocar el consentimiento en cualquier momento</li>
									<li><strong>Derecho de control de acceso:</strong> Controlar qué profesionales de la salud pueden acceder a la información del menor</li>
								</ul>
							</div>
							...
							<div className="bg-gray-50 rounded-xl p-4">
								...
								<p className="text-sm">
									Los profesionales de la salud autorizados pueden crear registros médicos para menores de edad cuando proporcionen atención médica, 
									siempre que:
								</p>
								<ul className="text-sm ml-6 mt-2 list-disc space-y-1">
							...
							<div className="p-4 bg-red-50 border-l-4 border-red-500 rounded-r-lg">
								<p className="text-sm text-red-800">
									<strong>Importante:</strong> Si cree que hemos recopilado información de un menor sin el consentimiento apropiado de su padre, 
									madre o tutor legal, o si tiene dudas sobre la veracidad de una relación legal declarada, contáctenos inmediatamente a través 
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							<p>
								Sus datos pueden ser almacenados y procesados en servidores ubicados fuera de Venezuela, incluyendo pero no limitado a Estados Unidos 
								y otros países donde operan nuestros proveedores de servicios en la nube.
							</p>
							<p>
								Al utilizar nuestros servicios, usted consiente la transferencia de su información a estos países. Nos aseguramos de que todas las 
								transferencias internacionales cumplan con las leyes aplicables y que sus datos estén protegidos mediante medidas de seguridad adecuadas.
							</p>
						</div>
					</section>
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							<p>
								Si tiene preguntas, inquietudes o solicitudes relacionadas con esta Política de Privacidad o el manejo de su información personal, 
					...
					<section className="space-y-4">
						...
						<div className="space-y-4 text-gray-700 leading-relaxed">
							<p>
								Al utilizar nuestros servicios, usted reconoce que ha leído, entendido y acepta esta Política de Privacidad y consiente la recopilación, 
								uso y divulgación de su información personal y de salud según se describe en esta política.
							</p>
							<p>
