...
type UserRole = 'ADMIN' | 'MEDICO' | 'ENFERMERA' | 'ENFERMERO' | 'RECEPCION' | 'FARMACIA' | 'PACIENTE' | 'ADMINISTRACION';
const VALID_ROLES: UserRole[] = ['ADMIN', 'MEDICO', 'ENFERMERA', 'ENFERMERO', 'RECEPCION', 'FARMACIA', 'PACIENTE', 'ADMINISTRACION'];
