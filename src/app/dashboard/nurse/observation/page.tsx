  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-gray-900  flex items-center gap-3 font-outfit">
        ...
        <button 
          ...
          className="p-3 bg-white  border border-gray-100  rounded-2xl hover:bg-gray-50 transition-all shadow-sm flex items-center gap-2 text-sm font-bold text-gray-600"
        >
      ...
      {/* Guidelines Card */}
      <div className="p-6 bg-teal-50  border border-teal-100  rounded-[2rem] flex gap-4">
        <Info className="w-6 h-6 text-teal-600 flex-shrink-0" />
        <div>
          <h4 className="text-sm font-black text-teal-900  mb-1 uppercase tracking-tight">Manual de Vigilancia</h4>
