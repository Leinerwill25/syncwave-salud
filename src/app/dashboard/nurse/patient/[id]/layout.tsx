      ...
      <div className="bg-white  rounded-3xl border border-gray-100  shadow-sm overflow-hidden">
        <div className="p-4 md:p-6 flex flex-col md:flex-row items-start md:items-center gap-6">
          <Link 
            ...
            className="p-2.5 rounded-xl bg-gray-50  border border-gray-100  hover:bg-gray-100 transition-colors hidden md:block"
          >
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
                ...
                {activePatient?.blood_type && (
                   <span className="flex items-center gap-1.5 text-xs font-bold text-red-600 bg-red-50  px-2 py-0.5 rounded-full">
          ...
          {activePatient?.allergies_flag && (
            <div className="px-4 py-2 bg-red-50  border border-red-100  rounded-xl flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-red-700  uppercase tracking-wider">Alergias Detectadas</span>
            </div>
          )}
        </div>

        {/* Tab Navigation */}
        <div className="px-4 md:px-6 border-t border-gray-50  bg-gray-50/30 ">
