...
import { MessageSquare, Send, Loader2, Search, User, Check, CheckCheck, Plus, Sparkles, Bot } from 'lucide-react';
...
export default function MensajeriaPage() {
	...
	const [currentUserType, setCurrentUserType] = useState<'user' | 'role_user'>('role_user');
					...
					if (isForCurrentUser || isFromCurrentUser) {
						...
						if (isFromSelectedConversation && currentConv) {
							setMessages((prev) => {
								...
								// Activar scroll automático cuando llega un mensaje nuevo
