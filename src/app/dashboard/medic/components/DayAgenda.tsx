	...
	return (
		<motion.div whileHover={{ y: -4 }} transition={{ type: 'spring', stiffness: 250, damping: 20 }} className="h-full w-full">
			<Card className="relative bg-white/95 backdrop-blur-md border border-gray-100 shadow-sm hover:shadow-xl transition-all rounded-2xl overflow-hidden">
				...
				<CardContent className="p-4 sm:p-6 relative z-10 flex flex-col gap-4 sm:gap-6">
					<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
						<div className="flex items-center gap-2">
							...
							<h3 className="text-base sm:text-lg font-semibold text-gray-800 tracking-tight">Agenda del Día</h3>
						</div>
					...
					<div className="flex justify-center items-center bg-linear-to-b from-white to-gray-50 border border-gray-100 rounded-xl sm:rounded-2xl shadow-inner p-3 sm:p-4">
						<DayPicker
							mode="single"
							selected={selected}
