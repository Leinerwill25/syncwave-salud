            ...
            <AnimatePresence mode="wait">
                {status === 'idle' && (
                    ...
                    >
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-2xl shadow-purple-900/10 relative z-10 overflow-hidden group">
                            
                            {/* Visual Hint for Desktop */}
                            <div className="absolute top-4 right-4 z-40">
                                <div className="bg-purple-50 backdrop-blur-md px-3 py-1 rounded-full border border-purple-100 flex items-center gap-2 text-xs font-medium text-purple-600">
                            ...
                            <div className="flex items-center justify-between mb-8 border-b border-slate-100 pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-slate-500 font-mono text-sm">Grabando...</span>
                                </div>
                            ...
                            <div className="flex justify-center -my-5 relative z-20">
                                <div className="bg-white rounded-full p-3 border border-purple-100 shadow-[0_0_15px_rgba(168,85,247,0.3)]">
                                    <BrainCircuit className="w-6 h-6 text-purple-600" />
                                </div>
                            </div>

                            {/* Result Preview */}
                            <div className="bg-slate-50 rounded-xl p-6 mt-4 shadow-inner relative border border-slate-200">
                                ...
                                <div className="space-y-2 opacity-50 blur-[1px]">
                                    ...
                                    <div className="p-2 bg-purple-50 rounded border-l-4 border-purple-500">
                                        <div className="text-[10px] text-purple-800 font-bold mb-1">DIAGNÓSTICO</div>
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                     <p className="text-slate-900 font-bold text-lg bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm border border-slate-100">
                                        Generando Informe...
                                     </p>
                                </div>
                            </div>
                        ...
                        <div className="mt-8 flex justify-center">
                            <button 
                                ...
                                className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-full font-bold text-lg shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden"
                            >
                ...
                {status === 'recording' && (
                    ...
                    >
                        <div className="relative w-24 h-24 mx-auto mb-6 flex items-center justify-center">
                            ...
                            <div className="relative bg-white p-4 rounded-full shadow-sm z-10 border border-red-50">
